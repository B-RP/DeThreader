          ...
          <div className="form">
            <div className="form-body">
              <div className="username">
                ...
                <input
                  className={`form__input ${showError ? "Show_Error" : ""}`}
                  type="text"
                  id="firstName"
              ...
              <div className="email">
                ...
                <input
                  ...
                  placeholder="Email"
                  // Function for view  changing of values
                  onChange={(e) => { 
                    setUserEmail(e.target.value);
                    setShowEmailError(false);
                  }}
                />
                {/* Error messaege div we will show and hide based on check */}
                {showEmailMessage && (
              ...
              <div className="password">
                ...
                <input
                  className={`form__input ${
                    showPasswordMessage ? "Show_Error" : ""
                  }`}
                  type="password"
                  id="password"
                ...
                />
                 {/* Error message div we will show and hide based on check */}
                {showPasswordMessage && (
              ...
              <div className="confirm-password">
                ...
                <input
                  className={`form__input ${
                    showConfirmdMessage ? "Show_Error" : ""
                  }`}
                  type="password"
                  id="confirmPassword"
                ...
                {/* Message for passwords NOT matching (not same) */}
                {/* <div className="Show_Email_Erro">{NotSameERRORMESSGAE}</div> */}
                {showNotSameMessage && (
                  <div className="Show_Email_Erro">{NotSameERRORMESSGAE}</div>
                )}
              </div>
