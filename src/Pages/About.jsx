    ...
    return (
      <div className="Background">
        ...
        <div className="ContentContainer">
          ...
          <p>Once you have logged in, you will be taken to the dashboard where you may start a session or continue a previous one.
          ...
          <p>
            If you see a plus icon, this means there are no sessions currently saved in your account. Select the plus button to create one.
            If you see a play icon, this means there is a session saved. You may click this button to continue the session or to delete it 
            in the next page. At this time, you may only have one session per account. 
          </p>

          <p>When creating a session, you will be met with plus button. Click on this button to add a task and use the text field to lable it.
